...
#define defaults_h
  ...
  #define DEFAULT_X_STEPS_PER_MM 1200.0
  #define DEFAULT_Y_STEPS_PER_MM 1200.0
  #define DEFAULT_Z_STEPS_PER_MM 1920.0
  #define DEFAULT_X_MAX_RATE 1500.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 1500.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 750.0 // mm/min
  #define DEFAULT_X_ACCELERATION (100.0*60*60) // 25*60*60 mm/min^2 = 25 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (100.0*60*60) // 25*60*60 mm/min^2 = 25 mm/sec^2
