...
#define X_DISABLE_BIT          0 // MEGA2560 Digital Pin 22
#define Y1_DISABLE_BIT         1 // MEGA2560 Digital Pin 23
#define Y2_DISABLE_BIT         2 // MEGA2560 Digital Pin 24
#define Z_DISABLE_BIT          3 // MEGA2560 Digital Pin 25
#define STEPPERS_DISABLE_MASK ((1<<X_DISABLE_BIT)|(1<<Y1_DISABLE_BIT)|(1<<Y2_DISABLE_BIT)|(1<<Z_DISABLE_BIT)) // All disable bits

// Define step pulse output pins. NOTE: All step bit pins must be on the same port.
#define STEP_DDR      DDRA
#define STEP_PORT     PORTA
#define X_STEP_BIT    4 // MEGA2560 Digital Pin 26
#define Y1_STEP_BIT   5 // MEGA2560 Digital Pin 27
#define Y2_STEP_BIT   6 // MEGA2560 Digital Pin 28
#define Z_STEP_BIT    7 // MEGA2560 Digital Pin 29
#define STEP_MASK     ((1<<X_STEP_BIT)|(1<<Y1_STEP_BIT)|(1<<Y2_STEP_BIT)|(1<<Z_STEP_BIT)) // All step bits
#define X_STEP_MASK   ((1<<X_STEP_BIT))
#define Y_STEP_MASK   ((1<<Y1_STEP_BIT)|(1<<Y2_STEP_BIT))
...
#define Y1_DIRECTION_BIT  6 // MEGA2560 Digital Pin 31
#define Y2_DIRECTION_BIT  5 // MEGA2560 Digital Pin 32
#define Z_DIRECTION_BIT   4 // MEGA2560 Digital Pin 33
#define DIRECTION_MASK    ((1<<X_DIRECTION_BIT)|(1<<Y1_DIRECTION_BIT)|(1<<Y2_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT)) // All direction bits
#define X_DIRECTION_MASK  ((1<<X_DIRECTION_BIT))
#define Y_DIRECTION_MASK  ((1<<Y1_DIRECTION_BIT)|(1<<Y2_DIRECTION_BIT))
